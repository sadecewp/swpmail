...
class SWPM_DNS_Checker {
	...
	public function on_settings_saved(): void {
		...
		set_transient( 'swpm_dns_notice', array(
			'type'    => $notice_type,
	...
	private function empty_result( string $domain ): array {
		return array(
			'domain'    => $domain,
			'spf'       => array( 'status' => 'missing', 'record' => '', 'details' => array( __( 'Invalid domain.', 'swpmail' ) ), 'warnings' => array() ),
			'dkim'      => array( 'status' => 'missing', 'records' => array(), 'details' => array( __( 'Invalid domain.', 'swpmail' ) ), 'warnings' => array() ),
			'dmarc'     => array( 'status' => 'missing', 'record' => '', 'policy' => '', 'details' => array( __( 'Invalid domain.', 'swpmail' ) ), 'warnings' => array() ),
			'overall'   => 'fail',
			'timestamp' => time(),
		);
	}
