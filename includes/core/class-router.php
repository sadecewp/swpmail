...
class SWPM_Router {
	...
	/** @var array Loaded rules (sorted by priority). */
	private array $rules = array();

	/** @var bool Whether rules have been loaded. */
	 ...
	 *   @type array  $headers Raw headers.
	 *   @type string $source  Source identifier (e.g., plugin name or 'wp_mail').
	 * }
